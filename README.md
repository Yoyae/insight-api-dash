<h1 align="center">Insight-api-monoeci</h1>

<div align="center">
  <strong>A Monoeci blockchain REST and WebSocket API Service</strong>
</div>
<br />
<div align="center">
  <!-- Stability -->
  ...
  <!-- Build Status -->
  <a href="https://travis-ci.org/yoyae/insight-api-monoeci">
    <img src="https://img.shields.io/travis/yoyae/insight-api-monoeci/master.svg?style=flat-square" alt="Build Status" />
  </a>
  <!-- NPM version -->
  <a href="https://npmjs.org/package/insight-api-monoeci">
    <img src="https://img.shields.io/npm/v/insight-api-monoeci.svg?style=flat-square" alt="NPM version" />
  </a>
</div>


This is a backend-only service. If you're looking for the web frontend application, take a look at https://github.com/yoyae/insight-ui-monoeci.
...
- [Resources](#resources)
- [License](https://github.com/yoyae/insight-api-monoeci/blob/master/LICENSE)

## Getting Started

```bashl
npm install -g bitcore-node-monoeci@latest
...
The API endpoints will be available by default at: `http://localhost:3001/insight-api-monoeci/`

### Prerequisites

- [Bitcore Node Monoeci 3.x](https://github.com/yoyae/bitcore-node-monoeci)

**Note:** You can use an existing Monoeci data directory, however `txindex`, `addressindex`, `timestampindex` and `spentindex` needs to be set to true in `monoeci.conf`, as well as a few other additional fields.
...
### Block
```
  /insight-api-monoeci/block/[:hash]
  /insight-api-monoeci/block/0000000006e7b38e8ab2d351239019c01de9a148b5baef58cfe52dfd9917cedc
```

### Block Index
Get block hash by height
```
  /insight-api-monoeci/block-index/[:height]
  /insight-api-monoeci/block-index/0
```
This would return:
```
{
...
### Raw Block
```
  /insight-api-monoeci/rawblock/[:blockHash]
```
...
```
  /insight-api-monoeci/blocks?limit=3&blockDate=2017-04-22
```
...
### Transaction
```
  /insight-api-monoeci/tx/[:txid]
  /insight-api-monoeci/tx/ebdca263fe1c75c8609ce8fe3d82a320a0b3ca840f4df995883f5dab1b9ff8d9
  /insight-api-monoeci/rawtx/[:rawid]
  /insight-api-monoeci/rawtx/ebdca263fe1c75c8609ce8fe3d82a320a0b3ca840f4df995883f5dab1b9ff8d9
```

### Address
```
  /insight-api-monoeci/addr/[:addr][?noTxList=1][&from=&to=]
  /insight-api-monoeci/addr/ybi3gej7Ea1MysEYLR7UMs3rMuLJH5aVsW?noTxList=1
  /insight-api-monoeci/addr/yPv7h2i8v3dJjfSH4L3x91JSJszjdbsJJA?from=1000&to=2000
```

### Address Properties
```
  /insight-api-monoeci/addr/[:addr]/balance
  /insight-api-monoeci/addr/[:addr]/totalReceived
  /insight-api-monoeci/addr/[:addr]/totalSent
  /insight-api-monoeci/addr/[:addr]/unconfirmedBalance
```
The response contains the value in Satoshis.

### Unspent Outputs
```
  /insight-api-monoeci/addr/[:addr]/utxo
```
Sample return:
```
[
...
GET method:
```
  /insight-api-monoeci/addrs/[:addrs]/utxo
  /insight-api-monoeci/addrs/ygwNQgE5f15Ygopbs2KPRYMS4TcffqBpsz,ygw5yCtVkx3hREke4L8qDqQtnNoAiPKTSx/utxo
```

POST method:
```
  /insight-api-monoeci/addrs/utxo
```
...
```
  /insight-api-monoeci/txs/?block=HASH
  /insight-api-monoeci/txs/?block=000000000814dd7cf470bd835334ea6624ebf0291ea857a5ab37c65592726375
```
### Transactions by Address
```
  /insight-api-monoeci/txs/?address=ADDR
  /insight-api-monoeci/txs/?address=yWFfdp9nLUjy1kJczFhRuBMUjtTkTTiyMv
```

### Transactions for Multiple Addresses
GET method:
```
  /insight-api-monoeci/addrs/[:addrs]/txs[?from=&to=]
  /insight-api-monoeci/addrs/ygwNQgE5f15Ygopbs2KPRYMS4TcffqBpsz,ygw5yCtVkx3hREke4L8qDqQtnNoAiPKTSx/txs?from=0&to=20
```

POST method:
```
  /insight-api-monoeci/addrs/txs
```
...
GET method:
```
  /insight-api-monoeci/gobject/list/proposal
```
...
GET method:
```
  /insight-api-monoeci/gobject/get/[:hash]
  /insight-api-monoeci/gobject/get/b6af3e70c686f660541a77bc035df2e5e46841020699ce3ec8fad786f7d1aa35
```
...
### Masternodes List
```
  /insight-api-monoeci/masternodes/list
```
### Validate Masternode
```
  /insight-api-monoeci/masternodes/validate/[:payee]
  /insight-api-monoeci/masternodes/validate/yRuALkPpeYpTgxdNn2L5YgGktASJYDYPAo
```
...
```
  /insight-api-monoeci/sync
```

### Live Network P2P Data Sync Status
```
  /insight-api-monoeci/peer
```

### Status of the Bitcoin Network
```
  /insight-api-monoeci/status?q=xxx
```
...
### Utility Methods
```
  /insight-api-monoeci/utils/estimatefee[?nbBlocks=2]
```
...
- (Medium)[How to setup a Monoeci Instant-Send Transaction using Insight API?????????The comprehensive way](https://medium.com/@obusco/setup-instant-send-transaction-the-comprehensive-way-a80a8a0572e)
