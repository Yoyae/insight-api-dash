...
BlockController.prototype.getBlockReward = function(prevHash, cb) {
  var self = this;
  var nBudgetPaymentsStartBlock = 130000;
  var nSubsidyBase;
  ...
  self.getPreviousBlock(prevHash, function(err, info) {
    ...
    if(info===null){
	    ...
	    var nSuperblockPart = (nPrevHeight > nBudgetPaymentsStartBlock) ? nSubsidyBase/10 : 0;
	    var reward = nSubsidyBase - nSuperblockPart;
